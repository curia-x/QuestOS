...
#define PG_PAGE_ENTRY_NORMAL_CACHEABLE_RX	( \
	PG_DESC_PAGE_XN_UXN_NX | PG_DESC_PAGE_PXN_X | PG_DESC_PAGE_AF_BIT | \
	PG_DESC_PAGE_SH_INNERSHAREABLE | PG_DESC_PAGE_AP_RO1_0 | \
	NORMAL_ATTR_CACHEABLE_IDX << PG_DESC_PAGE_ATTR_INDEX_OFFSET)
