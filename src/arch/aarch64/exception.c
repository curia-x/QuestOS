...
int set_handle_irq(void (*handle_irq)(struct pt_regs *))
{
	...
	pr_debug("Root IRQ handler: 0x%p\n", handle_irq);
	return 0;
}
...
{
	pr_err("Bad mode for %s handler detected, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
...
{
	pr_err("EL1t_64 Sync handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
...
{
	pr_err("EL1t_64 IRQ handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
...
{
	pr_err("EL1t_64 FIQ handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
...
{
	pr_err("EL1t_64 Error handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
...
{
	pr_err("EL1h_64 Sync handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
...
{
	pr_err("EL1h_64 FIQ handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
...
{
	pr_err("EL1h_64 Error handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
...
void el0t_64_sync_handler(struct pt_regs *regs)
{
	...
	case ESR_EC_SVC:
		...
		break;
	default:
		pr_err("EL0t_64 sync handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
		break;
	}
...
{
	pr_err("EL0t_64 FIQ handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
...
{
	pr_err("EL0t_64 Error handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
...
{
	pr_err("EL0t_32 Sync handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
...
{
	pr_err("EL0t_32 IRQ handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
...
{
	pr_err("EL0t_32 FIQ handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
...
{
	pr_err("EL0t_32 Error handler called, FAR_EL1:0x%llx ESR_EL1:0x%llx, ELR_EL1:0x%llx\n",
			read_sysreg(FAR_EL1), read_sysreg(ESR_EL1),
			read_sysreg(ELR_EL1));
}
