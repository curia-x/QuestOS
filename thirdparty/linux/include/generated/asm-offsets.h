...
#define THREAD_CPU_CONTEXT 5440 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 7088 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 6984 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 7064 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 7080 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define PT_REGS_SIZE 272 /* sizeof(struct pt_regs) */
...
#define FTRACE_OPS_DIRECT_CALL 432 /* offsetof(struct ftrace_ops, direct_call) */
